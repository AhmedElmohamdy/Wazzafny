                ...
                <div class="mb-4 p-6 bg-gray-50 border border-gray-100 rounded-lg shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="title" class="block mt-1 w-full" type="text" name="title"
                            :value="old('title', $jobVacancy->title)" required autofocus />
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="location" class="block mt-1 w-full" type="text" name="location"
                            :value="old('location', $jobVacancy->location)" required />
                    ...
                    <div class="mb-4">
                        ...
                        <select id="type" name="type"
                            ...
                            <option value="part-time" {{ old('type', $jobVacancy->type) == 'part-time' ? 'selected' : '' }}>Part-time
                            </option>
                            <option value="contract" {{ old('type', $jobVacancy->type) == 'contract' ? 'selected' : '' }}>Contract
                            </option>
                            <option value="hybrid" {{ old('type', $jobVacancy->type) == 'hybrid' ? 'selected' : '' }}>Hybrid
                            </option>
                        </select>
                        ...
                        <select id="category_id" name="category_id"
                            ...
                            @foreach ($jobCategories as $category)
                                <option value="{{ $category->id }}"
                                    {{ old('category_id', $jobVacancy->category_id) == $category->id ? 'selected' : '' }}>
